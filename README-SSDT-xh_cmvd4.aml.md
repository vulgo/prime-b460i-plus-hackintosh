...
**The end user may edit this table, disabling unused USB ports** in order to keep within the macOS 15 port limit. For changes in ```xh_cmvd4``` to be effective, ```USBPortInjector.kext``` or any kernel extensions with a similar function must __NOT__ be loaded.
